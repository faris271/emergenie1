const emergencies = [
  ...
  "Sudden Weakness or Slurred Speech (Stroke)",
  "Burns or Scalds",
  "Poisoning",
  "Drug Overdose",
  "Feeling Dizzy or Weak from Diabetes",
  "Drowning",
  "Feeling Overheated or Faint from Heat (Heat stroke)",
      ...
      if (emergencyInstructions) {
        instructionsDiv.innerHTML = `
          <div class="alert alert-danger">
            <i class="fas fa-phone-alt"></i> <strong>Emergency!</strong> ${emergencyInstructions.emergency}
          </div>
